...
<body>
    <div class="body" id="body">
        ...
        <!--中间视频区-->
        <div class="main">
            <iframe style="margin: 8% auto;" frameborder="0" height="80%" width="100%" scrolling="no" marginheight="0" marginwidth="0" border="0" src="<?php echo ($channel_link); ?>"></iframe>
        </div>
        <!--右侧节目单-->
        <div class="right">
            <div class="tab">
                <div class="tab-time">时间</div>
                <div class="tab-menu">节目</div>
            </div>
            <div class="content">
